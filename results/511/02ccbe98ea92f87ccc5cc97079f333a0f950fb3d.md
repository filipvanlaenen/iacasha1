...
Least complex input bit: iv_494 (7.200000000000011 × 10^1)  
Most complex input bit: iv_494 (7.200000000000011 × 10^1)

Least complex output bit: false (0. × 10^0)  
Most complex output bit: iv_494 (7.200000000000011 × 10^1)

Least complex input/output complexity: iv_494/false (0. × 10^0)  
Most complex input/output complexity:  (1.0 × 10^0)

Input variable with highest collision probability: iv_494 (½^Infinity)
...
|:---------:|:----------:|:-----------:|:------------------:|:---------------------:|
| iv_494 | 7.200000000000011 × 10^1 |  |  | ½^Infinity |
...
|:----:|:----------:|:----------:|
| 1 | iv_494 | 7.200000000000011 × 10^1 |
| 2 | false | 0. × 10^0 |
| 3 | true | 0. × 10^0 |
