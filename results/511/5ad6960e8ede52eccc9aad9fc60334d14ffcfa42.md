...
Total complexity: 7.600000000000009 × 10^1
...
Least complex input bit: iv_509 (7.600000000000009 × 10^1)  
Most complex input bit: iv_509 (7.600000000000009 × 10^1)

Least complex output bit: false (0. × 10^0)  
Most complex output bit: iv_509 (7.600000000000009 × 10^1)

Least complex input/output complexity:  (0. × 10^0)  
Most complex input/output complexity: iv_509/iv_509 (1.0 × 10^0)

Input variable with highest collision probability: iv_509 (½^Infinity)
...
|:---------:|:----------:|:-----------:|:------------------:|:---------------------:|
| iv_509 | 7.600000000000009 × 10^1 |  |  | ½^Infinity |
...
| 1 | false | 0. × 10^0 |
| 2 | true | 0. × 10^0 |
| 3 | iv_509 | 7.600000000000009 × 10^1 |
