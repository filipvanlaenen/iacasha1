...
Least complex input bit: iv_498 (9.2 × 10^1)  
Most complex input bit: iv_498 (9.2 × 10^1)

Least complex output bit: true (0. × 10^0)  
Most complex output bit: iv_498 (9.2 × 10^1)
