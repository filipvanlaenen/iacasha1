...
Least complex input bit: iv_493 (7.600000000000009 × 10^1)  
Most complex input bit: iv_493 (7.600000000000009 × 10^1)

Least complex output bit: true (0. × 10^0)  
Most complex output bit: iv_493 (7.600000000000009 × 10^1)

Least complex input/output complexity:  (0. × 10^0)  
Most complex input/output complexity: iv_493/iv_493 (1.0 × 10^0)

Input variable with highest collision probability: iv_493 (½^Infinity)
...
|:---------:|:----------:|:-----------:|:------------------:|:---------------------:|
| iv_493 | 7.600000000000009 × 10^1 |  |  | ½^Infinity |
...
|:----:|:----------:|:----------:|
| 1 | true | 0. × 10^0 |
| 2 | iv_493 | 7.600000000000009 × 10^1 |
| 3 | false | 0. × 10^0 |
