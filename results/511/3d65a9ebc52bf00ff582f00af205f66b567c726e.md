...
Least complex input bit: iv_512 (8.100000000000006 × 10^1)  
Most complex input bit: iv_512 (8.100000000000006 × 10^1)

Least complex output bit: false (0. × 10^0)  
Most complex output bit: iv_512 (8.100000000000006 × 10^1)

Least complex input/output complexity:  (0. × 10^0)  
Most complex input/output complexity: iv_512/iv_512 (1.0 × 10^0)
...
|:---------:|:----------:|:-----------:|:------------------:|:---------------------:|
| iv_512 | 8.100000000000006 × 10^1 |  |  | ½^Infinity |
...
|:----:|:----------:|:----------:|
| 1 | false | 0. × 10^0 |
| 2 | iv_512 | 8.100000000000006 × 10^1 |
| 3 | true | 0. × 10^0 |
