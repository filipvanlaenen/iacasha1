...
Least complex input bit: iv_508 (8.500000000000004 × 10^1)  
Most complex input bit: iv_508 (8.500000000000004 × 10^1)

Least complex output bit: false (0. × 10^0)  
Most complex output bit: iv_508 (8.500000000000004 × 10^1)

Least complex input/output complexity:  (0. × 10^0)  
Most complex input/output complexity: iv_508/iv_508 (1.0 × 10^0)

Input variable with highest collision probability: iv_508 (½^Infinity)
...
|:---------:|:----------:|:-----------:|:------------------:|:---------------------:|
| iv_508 | 8.500000000000004 × 10^1 |  |  | ½^Infinity |
...
|:----:|:----------:|:----------:|
| 1 | false | 0. × 10^0 |
| 2 | iv_508 | 8.500000000000004 × 10^1 |
| 3 | true | 0. × 10^0 |
