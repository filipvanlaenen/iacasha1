...
Least complex input bit: iv_002 (7.40000000000001 × 10^1)  
Most complex input bit: iv_002 (7.40000000000001 × 10^1)

Least complex output bit: true (0. × 10^0)  
Most complex output bit: iv_002 (7.40000000000001 × 10^1)

Least complex input/output complexity:  (0. × 10^0)  
Most complex input/output complexity: iv_002/iv_002 (1.0 × 10^0)

Input variable with highest collision probability: iv_002 (2^-Infinity)
...
|:---------:|:----------:|:-----------:|:------------------:|:---------------------:|
| iv_002 | 7.40000000000001 × 10^1 |  |  | 2^-Infinity |
...
|:----:|:----------:|:----------:|
| 1 | true | 0. × 10^0 |
| 2 | iv_002 | 7.40000000000001 × 10^1 |
| 3 | false | 0. × 10^0 |
