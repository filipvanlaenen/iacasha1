...
Least complex input bit: iv_510 (9.2 × 10^1)  
Most complex input bit: iv_510 (9.2 × 10^1)

Least complex output bit: true (0. × 10^0)  
Most complex output bit: iv_510 (9.2 × 10^1)

Least complex input/output complexity: iv_510/true (0. × 10^0)  
Most complex input/output complexity:  (1.0 × 10^0)

Input variable with highest collision probability: iv_510 (2^-Infinity)
