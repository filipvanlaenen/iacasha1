...
Least complex input bit: iv_504 (8.500000000000004 × 10^1)  
Most complex input bit: iv_504 (8.500000000000004 × 10^1)

Least complex output bit: true (0. × 10^0)  
Most complex output bit: iv_504 (8.500000000000004 × 10^1)

Least complex input/output complexity: iv_504/true (0. × 10^0)  
...
|:---------:|:----------:|:-----------:|:------------------:|:---------------------:|
| iv_504 | 8.500000000000004 × 10^1 |  |  | ½^Infinity |
...
|:----:|:----------:|:----------:|
| 1 | iv_504 | 8.500000000000004 × 10^1 |
| 2 | true | 0. × 10^0 |
| 3 | false | 0. × 10^0 |
