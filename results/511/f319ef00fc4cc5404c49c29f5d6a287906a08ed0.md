...
Total complexity: 7.300000000000011 × 10^1
...
Least complex input bit: iv_510 (7.300000000000011 × 10^1)  
Most complex input bit: iv_510 (7.300000000000011 × 10^1)

Least complex output bit: true (0. × 10^0)  
Most complex output bit: iv_510 (7.300000000000011 × 10^1)

Least complex input/output complexity:  (0. × 10^0)  
Most complex input/output complexity: iv_510/iv_510 (1.0 × 10^0)
...
|:---------:|:----------:|:-----------:|:------------------:|:---------------------:|
| iv_510 | 7.300000000000011 × 10^1 |  |  | 2^-Infinity |
...
| 1 | true | 0. × 10^0 |
| 2 | false | 0. × 10^0 |
| 3 | iv_510 | 7.300000000000011 × 10^1 |
