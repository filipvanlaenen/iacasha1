...
Least complex input bit: iv_506 (7.200000000000011 × 10^1)  
Most complex input bit: iv_506 (7.200000000000011 × 10^1)

Least complex output bit: false (0. × 10^0)  
Most complex output bit: iv_506 (7.200000000000011 × 10^1)

Least complex input/output complexity:  (0. × 10^0)  
Most complex input/output complexity: iv_506/iv_506 (1.0 × 10^0)

Input variable with highest collision probability: iv_506 (½^Infinity)
...
|:---------:|:----------:|:-----------:|:------------------:|:---------------------:|
| iv_506 | 7.200000000000011 × 10^1 |  |  | ½^Infinity |
...
|:----:|:----------:|:----------:|
| 1 | false | 0. × 10^0 |
| 2 | iv_506 | 7.200000000000011 × 10^1 |
| 3 | true | 0. × 10^0 |
