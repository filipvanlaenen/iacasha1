...
Least complex input bit: iv_512 (8.200000000000005 × 10^1)  
Most complex input bit: iv_512 (8.200000000000005 × 10^1)

Least complex output bit: true (0. × 10^0)  
Most complex output bit: iv_512 (8.200000000000005 × 10^1)

Least complex input/output complexity: iv_512/true (0. × 10^0)  
Most complex input/output complexity:  (1.0 × 10^0)

Input variable with highest collision probability: iv_512 (2^-Infinity)
...
|:---------:|:----------:|:-----------:|:------------------:|:---------------------:|
| iv_512 | 8.200000000000005 × 10^1 |  |  | 2^-Infinity |
...
|:----:|:----------:|:----------:|
| 1 | iv_512 | 8.200000000000005 × 10^1 |
| 2 | true | 0. × 10^0 |
| 3 | false | 0. × 10^0 |
