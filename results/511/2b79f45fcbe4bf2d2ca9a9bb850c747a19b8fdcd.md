...
Total complexity: 7.50000000000001 × 10^1
...
Least complex input bit: iv_505 (7.50000000000001 × 10^1)  
Most complex input bit: iv_505 (7.50000000000001 × 10^1)

Least complex output bit: true (0. × 10^0)  
Most complex output bit: iv_505 (7.50000000000001 × 10^1)

Least complex input/output complexity:  (0. × 10^0)  
Most complex input/output complexity: iv_505/iv_505 (1.0 × 10^0)

Input variable with highest collision probability: iv_505 (½^Infinity)
...
|:---------:|:----------:|:-----------:|:------------------:|:---------------------:|
| iv_505 | 7.50000000000001 × 10^1 |  |  | ½^Infinity |
...
| 1 | true | 0. × 10^0 |
| 2 | false | 0. × 10^0 |
| 3 | iv_505 | 7.50000000000001 × 10^1 |
