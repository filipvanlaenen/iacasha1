...
Least complex input bit: iv_511 (7.50000000000001 × 10^1)  
Most complex input bit: iv_511 (7.50000000000001 × 10^1)

Least complex output bit: false (0. × 10^0)  
Most complex output bit: iv_511 (7.50000000000001 × 10^1)

Least complex input/output complexity:  (0. × 10^0)  
Most complex input/output complexity: iv_511/iv_511 (1.0 × 10^0)
...
|:---------:|:----------:|:-----------:|:------------------:|:---------------------:|
| iv_511 | 7.50000000000001 × 10^1 |  |  | ½^Infinity |
...
| 1 | false | 0. × 10^0 |
| 2 | true | 0. × 10^0 |
| 3 | iv_511 | 7.50000000000001 × 10^1 |
