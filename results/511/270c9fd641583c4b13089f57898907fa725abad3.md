...
Least complex input bit: iv_510 (9.1 × 10^1)  
Most complex input bit: iv_510 (9.1 × 10^1)

Least complex output bit: false (0. × 10^0)  
Most complex output bit: iv_510 (9.1 × 10^1)
